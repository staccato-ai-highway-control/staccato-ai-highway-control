...
def list_resources_api():
    # TODO: Expand access by category.
    # RESUME/COVER_LETTER: owner or SUPER_ADMIN.
    # PRESENTATION/MEETING_NOTE: all admin roles.
...
def delete_resource_api(resource_id: int):
    result, status_code = delete_resource(resource_id)
    return jsonify(result), status_code
